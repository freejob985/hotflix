...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('category/nav/{id}','CategoryController@nav')->name('category.nav');

        //Sub Category
        Route::get('sub-category','CategoryController@subcategory')->name('subcategory.index');
        Route::post('sub-category/store','CategoryController@subcategorystore')->name('subcategory.store');
        Route::get('subcategory/status/{id}','CategoryController@subCatstatus')->name('subcategory.status');
        Route::post('subcategory/update/{id}','CategoryController@subupdate')->name('subcategory.update');

        //Item Controller
        Route::get('video-item-status/{id}','ItemController@status')->name('item.status');
        Route::get('video-items','ItemController@items')->name('item.index');
        Route::get('video-items/single','ItemController@singleItems')->name('item.single');
        Route::get('video-items/trailer','ItemController@trailerItems')->name('item.trailer');
        Route::get('video-items/episode','ItemController@episodeItems')->name('item.episode');
        Route::get('video-item-create','ItemController@create')->name('item.create');
        Route::post('video-item-store','ItemController@store')->name('item.store');
        Route::get('video-item-edit/{id}','ItemController@edit')->name('item.edit');
        Route::post('video-item-update/{id}','ItemController@update')->name('item.update');
        Route::get('video-item-upload-video/{id}','ItemController@uploadVideo')->name('item.uploadVideo');
        Route::post('video-item-upload-video/{id}','ItemController@upload')->name('item.upVideo');
        Route::get('video-item-update-video/{id}','ItemController@updateVideo')->name('item.updateVideo');
        Route::post('video-item-update-video/{id}','ItemController@updateItemVideo');
        Route::get('single-section/{id}','ItemController@singleSection')->name('item.single_section');
        Route::get('featured/{id}','ItemController@featured')->name('item.featured');
        Route::get('trending/{id}','ItemController@trending')->name('item.trending');
        Route::get('search','ItemController@search')->name('item.search');

        //Episode
        Route::get('episodes/{id}','EpisodeController@episodes')->name('item.episodes');
        Route::post('add-episode/{id}','EpisodeController@addEpisode')->name('item.addEpisode');
        Route::post('edit-episode/{id}','EpisodeController@editEpisode')->name('item.editEpisode');
        Route::get('video-item-episodeStatus/{id}','EpisodeController@episodeStatus')->name('item.episodeStatus');
        Route::get('add-episode-video/{id}','EpisodeController@addEpisodeVideo')->name('item.episode.addVideo');
        Route::post('add-episode-video/{id}','EpisodeController@storeEpisodeVideo')->name('item.episode.upload');
        Route::get('update-episode-video/{id}','EpisodeController@updateEpisodeVideo')->name('item.episode.updateVideo');
        Route::post('update-episode-video/{id}','EpisodeController@editEpisodeVideo');


        //Slider
        Route::get('sliders','SliderController@index')->name('sliders.index');
        Route::post('add-sliders','SliderController@addSlider')->name('sliders.add');
        Route::post('update-slider/{id}','SliderController@update')->name('sliders.update');
        Route::post('remove-slider','SliderController@remove')->name('sliders.remove');

        //Ajax Subcategory Route
        Route::post('subCat','ItemController@subCat')->name('subCat');

        //Plans
        Route::get('plan','PlanController@index')->name('plan.index');
        Route::post('plan/store','PlanController@store')->name('plan.store');
        Route::get('plan/status/{id}','PlanController@status')->name('plan.status');
        ...
        //AWS Setting
        Route::get('aws-setting', 'GeneralSettingController@aws')->name('setting.aws');
        Route::post('aws-setting', 'GeneralSettingController@awsSet');

        //Advertisement
        Route::name('advertise.')->prefix('advertise')->group(function(){
            Route::get('advertise','AdvertiseController@index')->name('index');
            Route::post('store','AdvertiseController@store')->name('store');
            Route::post('edi/{id}','AdvertiseController@edit')->name('edit');
            Route::post('remove','AdvertiseController@remove')->name('remove');
        });
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            //Subscribe Plan
            Route::post('subscribe-plan','UserController@subscribePlan')->name('subscribePlan');
        });
    });
});
...
Route::get('/getSection', 'SiteController@getSection')->name('getSection');
Route::get('watch-video/{id}','SiteController@watchVideo')->name('watch');

Route::get('category/{id}','SiteController@category')->name('category');
Route::get('sub-category/{id}','SiteController@subCategory')->name('subCategory');
Route::get('search','SiteController@search')->name('search');

Route::get('load-more','SiteController@loadMore')->name('loadmore.load_data');

Route::get('company-policy/{id}/{slug}', 'SiteController@policy')->name('policies');
Route::get('links/{id}/{slug}', 'SiteController@links')->name('links');
Route::post('addClick','SiteController@addclick')->name('addclick');
