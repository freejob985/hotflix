...
Route::namespace('Api')->name('api.')->group(function(){
    ...
    Route::get('homepage/sections', 'HomePageController@getAllSection');
    Route::get('homepage/allCategories', 'HomePageController@allCategories');
    Route::get('homepage/category/{id}', 'HomePageController@category');
    Route::post('homepage/search', 'HomePageController@search');
    Route::get('homepage/user-movie/{id}', 'HomePageController@watchVideo');
    ...
    Route::middleware('auth.api:sanctum')->name('user.')->prefix('user')->group(function(){
        ...
        Route::middleware(['checkStatusApi'])->group(function(){
            ...
            Route::post('homepage', 'HomePageController@getSection');
            Route::post('movies/show/all', 'HomePageController@allFilms');

            Route::post('wishlist/view', 'HomePageController@wishlistView');
            Route::post('wishlistAdd', 'HomePageController@wishlistAdd');
            Route::post('wishlist/remove', 'HomePageController@wishlistRemove');

            // Withdraw
            Route::get('withdraw/methods', 'UserController@withdrawMethods');
            Route::post('withdraw/store', 'User Controller@withdrawStore');
