...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        //Items
        $widget['total_items'] = Item::count();
        $widget['single_items'] = Item::singleItems()->count();
        $widget['episode_items'] = Item::episodeItems()->count();
        $widget['trailer_items'] = Item::trailerItems()->count();
