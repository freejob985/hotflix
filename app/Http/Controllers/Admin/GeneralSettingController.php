...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'timezone' => 'required',
            'file_server' => 'required|in:current,custom-ftp,s3'
        ]);
    ...
    public function aws(){
        $setting = GeneralSetting::first();
        $pageTitle = "Amazon Web Service Setting";
        return view('admin.setting.aws',compact('pageTitle','setting'));
    }

    public function awsSet(Request $request){
        $request->validate([
            'aws.access_key'=>'required',
            'aws.secret_access_key'=>'required',
            'aws.regeion'=>'required',
            'aws.bucket'=>'required',
            'aws.url'=>'required',
        ...
        $notify[] = ['success', 'AWS Setting Updated'];
        return back()->withNotify($notify);
    }
}
