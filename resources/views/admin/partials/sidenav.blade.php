    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.setting.aws')}}">
                    <a href="{{route('admin.setting.aws')}}" class="nav-link">
                        <i class="menu-icon lab la-aws"></i>
                        <span class="menu-title">@lang('AWS Settings')</span>
                    </a>
                </li>
