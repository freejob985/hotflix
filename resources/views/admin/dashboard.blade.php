      ...
      <div class="row mt-50 mb-none-30">
          <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
              <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                  ...
                  <div class="details">
                      <div class="numbers">
                          <span class="amount">{{$widget['total_items']}}</span>
                      </div>
                      <div class="desciption">
                          <span>@lang('Total Items')</span>
                      </div>
                      <a href="{{ route('admin.item.index') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                  </div>
              </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
              <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                  ...
                  <div class="details">
                      <div class="numbers">
                          <span class="amount">{{$widget['single_items']}}</span>
                      </div>
                      <div class="desciption">
                          <span>@lang('Single Items')</span>
                      </div>
                      <a href="{{ route('admin.item.single') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                  </div>
              </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
              <div class="dashboard-w1 bg--12 b-radius--10 box-shadow" >
                  ...
                  <div class="details">
                      <div class="numbers">
                          <span class="amount">{{$widget['episode_items']}}</span>
                      </div>
                      <div class="desciption">
                          <span>@lang('Episode Items')</span>
                      </div>

                      <a href="{{ route('admin.item.episode') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                  </div>
              </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
              <div class="dashboard-w1 bg--7 b-radius--10 box-shadow">
                  ...
                  <div class="details">
                      <div class="numbers">
                          <span class="amount">{{$widget['trailer_items']}}</span>
                      </div>
                      <div class="desciption">
                          <span>@lang('Trailer Items')</span>
                      </div>

                      <a href="{{ route('admin.item.trailer') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                  </div>
              </div>
          </div>
      </div>
