    	...
    	<div class="card upload-card">
    		<form action="" method="post" enctype="multipart/form-data" id="upload-video">
    			...
    			<div class="card-footer">
    				<button class="btn btn--primary w-100 submitButton">@lang('Upload Video')</button>
    			</div>
    		</form>
    	</div>
    </div>
...
<a href="{{ $prevUrl }}" class="btn btn-sm btn--primary"><i class="la la-fw la-backward"></i> @lang('Go Back')</a>
@endpush
@push('script')
