<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Start Movie
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<section class="movie-section section--bg pt-80 section" data-section="single">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-30">
                    <div class="movie-item">
                        <div class="movie-thumb">
                            <img src="{{ getImage('assets/images/item/portrait/'.$latestSeries->image->portrait) }}" alt="movie">
