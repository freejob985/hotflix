                ...
                <div class="col-xl-10">
                    <div class="card custom--card">
                        <div class="card-header d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <button class="btn--secondary btn-sm close-button" type="button"
                                    title="@lang('Close Ticket')" data-toggle="modal" data-target="#DelModal"><i
                            ...
                            @if($my_ticket->status != 4)
                                <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea name="message"
                                                          ...
                                                          id="inputMessage" placeholder="@lang('Your Reply')" rows="4"
                                                          cols="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-between">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="position-relative">
                                                            <input type="file" name="attachments[]"
                                                                   id="inputAttachments"
                                                                   class="form-control form--control custom--file-upload my-1"/>
                                                ...
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        <a href="javascript:void(0)"
                                                           class="btn btn--default btn-sm mt-2 addFile">
                                        ...
                                        <div class="col-md-3">
                                            <button type="submit" class="btn btn--default custom-success mt-2">
