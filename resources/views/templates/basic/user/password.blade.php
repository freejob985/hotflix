                                ...
                                <form action="" method="post" role="form">
                                    ...
                                    <div class="row justify-content-center mb-20-none">
                                        ...
                                        <div class="col-xl-12 form-group hover-input-popup">
                                            <input id="password" type="password" placeholder="@lang('Password')" class="form--control" name="password" required autocomplete="current-password">
                                        ...
                                        <div class="col-xl-12 form-group">
                                            <input id="password_confirmation" type="password" class="form--control" placeholder="@lang('Confirm Password')" name="password_confirmation" required autocomplete="current-password">
                                        </div>
                                        <div class="col-xl-12 form-group">
